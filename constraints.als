...
pred constraintCannotTagSameUserTwiceInOnePhoto {
...
-- Tag should have some isTagged and some hasTagged
pred constraintTagSholdAlwaysBeMappedToTaggerTaggee {
	Tag = User.isTagged
	Tag = User.hasTagged
}

-- Tagging is permitted only to friends
